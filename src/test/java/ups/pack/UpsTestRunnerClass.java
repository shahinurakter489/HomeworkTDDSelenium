...
public class UpsTestRunnerClass extends BrowserDriver {
	...
	void loginErrorMessageTest() {
		...
		upsLoginPage.clickPhoneButton();
		upsLoginPage.clickSignUpLink();
		upsLoginPage.deleteallcookies();
		upsLoginPage.show("show");
		upsLoginPage.checkBox();
